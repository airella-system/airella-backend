...
--changeset jakubdybczak:1596149592786-1
...
--changeset jakubdybczak:1596149592786-2
...
--changeset jakubdybczak:1596149592786-3
CREATE TABLE client_role (id BIGINT NOT NULL, roles VARCHAR(255));

--changeset jakubdybczak:1596149592786-4
...
--changeset jakubdybczak:1596149592786-5
...
--changeset jakubdybczak:1596149592786-6
CREATE TABLE station (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, latitude FLOAT8 NOT NULL, longitude FLOAT8 NOT NULL, name VARCHAR(255), station_visibility VARCHAR(255), address_id BIGINT, owner_id BIGINT, station_client_id BIGINT, CONSTRAINT "stationPK" PRIMARY KEY (id));

--changeset jakubdybczak:1596149592786-7
CREATE TABLE station_client (id BIGINT NOT NULL, CONSTRAINT "station_clientPK" PRIMARY KEY (id));

--changeset jakubdybczak:1596149592786-8
...
--changeset jakubdybczak:1596149592786-9
